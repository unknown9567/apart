...
def get_dataloader(args):
    ...
    train_dataset = dataset_cls('./data/datasets/cifar', True, T.Compose(transforms), download=True)
    test_dataset = dataset_cls('./data/datasets/cifar', False, T.Compose([T.ToTensor(), normalize]), download=True)
